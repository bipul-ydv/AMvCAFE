package com.amex.amvcafe.videostream.service;

import com.amex.amvcafe.videostream.constants.ApplicationConstants;
...
public class VideoStreamService {
    ...
    public ResponseEntity<byte[]> prepareContent(String fileName, String fileType, String range) {
        System.out.println(fileName+" "+fileType+" "+range);
        long rangeStart = 0;
        long rangeEnd;
        byte[] data;
        Long fileSize;
